...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for(let i = 0; i < shuffledImageClasses.length; i++) {
    let addCard = appendNewCard(parentElement);
    addCard.classList.add(shuffledImageClasses[i])
  ...
  // Step 3: Return the array of 12 card objects.
    ...
    cardObjects.push(addCardObject);}
...
function doCardsMatch(cardObject1, cardObject2) {
  if (cardObject1.imageClass == cardObject2.imageClass){
    ...
    cardObject1.imageClass != cardObject2.imageClass
  }
   return false
}
doCardsMatchTest();
